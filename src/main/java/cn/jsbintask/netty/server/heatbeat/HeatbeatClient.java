 ...
 * @date 2020/6/1 17:44
 */
public class HeatbeatClient extends SimpleChannelInboundHandler<String> {
    ...
    public static void main(String[] args) {
        HeatbeatClient heatbeatClient = new HeatbeatClient();
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel ch) throws Exception {
                        ...
                        pipeline.addLast("stringDecoder", new StringDecoder())
                                ...
                                .addLast("chatRoomHandler", heatbeatClient);
                    }
                });
        ...
        new Thread(() -> {
            while (true) {
                ...
                heatbeatClient.channel.writeAndFlush(msg);
            }
        }).start();
    }
}
